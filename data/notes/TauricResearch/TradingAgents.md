...
<svg viewBox="0 0 800 430" role="img" aria-label="見出しに「会社の役割分担をそのまま並べる」とある図。左から「分析班（材料を集める）」で財務、ニュース・景気、SNSの空気、テクニカル指標を見る。次に「研究班（わざと対立させる）」で強気と弱気が決めた回数だけ討論し、利益と危険を突き合わせる。次に「売買案 → 審査（時期と量を決める）」で、トレーダーが案を書く、リスク班が評価する、責任者が承認／却下、と進む。右は「模擬取引所（研究用の枠組み）」で、承認された注文だけが約定する。下に「結果と反省を判断ログに残し、次の分析に差し込む」と、締めの一行「どこで判断が変わったかを役割ごとに追える。これが1回聞くのとの違いになる」がある。" style="width: 100%; height: auto; display: block; font-family: var(--jp);">
  <defs>
