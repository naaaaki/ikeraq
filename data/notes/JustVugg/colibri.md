...
**まだ変化が大きい。** 2026年7月に公開されたばかりで、リリースはすでに10回以上、参加者は100人を超える。未解決のものは issue とプルリクエスト合わせて110件あまり残っている。ライセンスは Apache 2.0 だが、**動かすモデルの重みには別のライセンスが付く**（GLM-5.2 は Z.ai が MIT で公開している、と README にある）。
