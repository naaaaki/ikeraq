...
<svg viewBox="0 0 800 430" role="img" aria-label="見出しに「指定が外れたら、似ている要素を探し直す」とある図。左に「1回目（取れている状態）」の箱があり、div.price から取る、同時にその要素の特徴を控えておく、※ 控える指定が要る と書かれている。左から中央へ矢印が伸びる。中央に「サイトが変わる（相手の都合・予告なし）」の箱があり、div.price ↓ div.cost と書かれ、普通はここで空になると添えられている。中央から右へ向かう矢印には「空振り」と書かれている。右に「2回目（探し直す）」の箱があり、控えた特徴に似た要素をページ全体から見つけて取り直す、セレクタは同じまま（※ 探し直す指定が要る）と書かれている。下に、止まるのではなく「空のまま動き続ける」のが、スクレイパーのいちばん厄介な壊れ方だと添えられている。" style="width: 100%; height: auto; display: block; font-family: var(--jp);">
  <defs>
