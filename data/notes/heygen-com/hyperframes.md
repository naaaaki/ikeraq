...
**動きの書き方に制約がある。** 「頭出しできるように書く」という条件は、ふだんのウェブのアニメーションの書き方と同じではない。頭出しできる形で書くことが前提になっている。ここは学習が要るところで、注意の中身は同梱のスキル側に書かれている。
...
**HeyGen という会社の公開物である点。** クラウドでの書き出しは同社の提供として案内されている。README は公開されている側について「書き出し1回ごとの課金も、商用利用の線引きも無い」と明記している。一方でクラウドでの書き出しの料金には触れていないので、そこは同社側で確かめることになる。
