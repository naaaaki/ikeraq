...
構造として覚えておきたいのは、**無償のCLIと有償のネイティブアプリが別物**だということ。CLI は GPL-3.0 で公開されていて、今後も無償だと書かれている。同じ作者が「Mole for Mac」という有償のGUIアプリを別に出している。README は CLI を「今後も無償・オープンソースのまま」とし、Mac 版は「別の商用アプリ」と書くだけで、両者の機能差がどこにあるかまでは触れていない。開発は活発で、2025年9月の公開から60回以上リリースされ、ほぼ毎日のように更新が入っている。未解決のものもほとんど残っていない。
