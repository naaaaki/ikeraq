...
**規模のわりに動きが速い。** 2026年4月の公開から5か月で11万を超えるスターが付き、リリースも100回を超えている。未解決のものは、不具合や要望が600件台、修正依頼が700件近く。伸びの理由までは当サイトでは確かめられていないが、**この数からすると、まだ落ち着いた段階ではなさそうに見える。** ライセンスは Apache-2.0 で、使うぶんの制約は緩い。
