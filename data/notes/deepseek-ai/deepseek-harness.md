...
**評価が固まるにはまだ早い時期です。** 公開から2週間あまりで20万スターというのは、中身が検証された結果というより、DeepSeek という名前への注目が大きいと見るのが自然です。リリースは15回を超えていますが、**すべて試験版の扱い**です。関わっている開発者は30人台。なお GitHub の Issue 機能はこのリポジトリでは無効にされていて、不具合や要望の受け口は Discussions のほうに置かれています。「未解決の Issue が0件」に見えるのは、そのためです。
